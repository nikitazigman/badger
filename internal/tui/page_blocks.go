...
const (
	...
	pageBlockFreelistPayload           = "freelist_payload"
	pageBlockBranchDescriptors         = "branch_descriptors"
	pageBlockBranchEntry               = "branch_entry"
	pageBlockBranchDescriptor          = "branch_descriptor"
	pageBlockLeafDescriptors           = "leaf_descriptors"
	pageBlockLeafEntry                 = "leaf_entry"
	pageBlockLeafDescriptor            = "leaf_descriptor"
	pageBlockLeafKey                   = "leaf_key"
	pageBlockLeafValue                 = "leaf_value"
	pageBlockInlinePageHeader          = "inline_page_header"
	pageBlockInlineLeafDescriptors     = "inline_leaf_descriptors"
	pageBlockInlineLeafEntry           = "inline_leaf_entry"
	pageBlockInlineLeafDescriptor      = "inline_leaf_descriptor"
	pageBlockInlineLeafKey             = "inline_leaf_key"
	pageBlockInlineLeafValue           = "inline_leaf_value"
	pageBlockInlineDescriptorFlags     = "inline_descriptor_flags"
	pageBlockInlineDescriptorPosition  = "inline_descriptor_position"
	pageBlockInlineDescriptorKeySize   = "inline_descriptor_key_size"
	pageBlockInlineDescriptorValueSize = "inline_descriptor_value_size"
	pageBlockInlineBucketRootPage      = "inline_bucket_root_page"
	pageBlockInlineBucketSequence      = "inline_bucket_sequence"
